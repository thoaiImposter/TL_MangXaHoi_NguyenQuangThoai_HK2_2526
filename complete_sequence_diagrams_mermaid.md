# Sequence Diagrams - NLU Social Network
...
Hệ thống NLU-social đã hoàn thành **8 nhóm chức năng chính** với đầy đủ các API endpoints tương ứng:

1. ✅ **Quản lý tài khoản** (Đăng ký, Đăng nhập)
2. ✅ **Quản lý hồ sơ** (Cập nhật thông tin, Đổi mật khẩu, Bảo vệ tài khoản)
3. ✅ **Quản lý bài viết** (Tạo, Cập nhật, Xóa)
4. ✅ **Tương tác với bài viết** (Like, Comment, Reply, Like comment)
5. ✅ **Kết nối người dùng** (Friend request, Accept, Unfriend, Xem danh sách)
6. ✅ **Quản lý tin nhắn** (Gửi, Thu hồi, Real-time qua WebSocket)
7. ✅ **Thông báo** (Nhận thông báo, Đánh dấu đã đọc)
8. ✅ **Tìm kiếm** (Tìm kiếm người dùng)
...
Tất cả các sequence diagrams trên đều sử dụng cú pháp Mermaid chuẩn và có thể được render trực tiếp trên [mermaid.live](https://mermaid.live).